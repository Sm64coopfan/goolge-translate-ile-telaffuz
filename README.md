...
- 🌐 **Çok Dilli Pratik:** İngilizce (en-US) ve Almanca (de-DE) dil seçenekleri.
...
- 🏆 **13 Gizli Başarım ve Rütbe:** Her turun performansına göre hesaplanan eğlenceli rütbeler ve gizli başarımlar.
...
Projenin çalışabilmesi için bilgisayarınızda **Python 3.x** kurulu olmalıdır. `os` ve `json` kütüphaneleri Python ile yerleşik olarak gelir; harici olarak yüklemeniz gerekmez.
...
- **Rütbeler:** Çaylak, Öğrenmeye İstekli, Akıcı Konuşur ve Dil Üstadı.
